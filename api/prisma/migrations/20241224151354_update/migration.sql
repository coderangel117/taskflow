...
-- AlterTable
ALTER TABLE `task`
  ADD COLUMN `status` ENUM('pending', 'completed', 'archived') NOT NULL DEFAULT 'pending',
...
-- AddForeignKey
ALTER TABLE `Event`
  ADD CONSTRAINT `Event_taskId_fkey` FOREIGN KEY (`taskId`) REFERENCES `Task` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Theme`
  ADD CONSTRAINT `Theme_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Preference`
  ADD CONSTRAINT `Preference_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
